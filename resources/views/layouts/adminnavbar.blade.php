  <!------ sidebar ------->
  <div id="sidebar">
      <ul class="pb-4" style="margin-top:41% !important">
          <!-- list item -->
          <li class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
              <a href="{{ route('admin.dashboard') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/layout.png') }}" alt="Dashboard" /> Dashboard
              </a>
          </li>
          ...
          <li class="{{ request()->routeIs('admin.invest-history') ? 'active' : '' }}">
              <a href="{{ route('admin.invest-history') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/growth-graph.png') }}" alt="Invest History" />
                  Invest History
              </a>
          </li>
          <li class="{{ request()->routeIs('admin.fund-history') ? 'active' : '' }}">
              <a href="{{ route('admin.fund-history') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/fund.png') }}" alt="Fund History" /> Fund History
              </a>
          </li>
          <li class="{{ request()->routeIs('admin.payout-history') ? 'active' : '' }}">
              <a href="{{ route('admin.payout-history') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/pay-history.png') }}" alt="Payout History" />
                  Payout History
              </a>
          </li>
          ...
          <li class="{{ request()->routeIs('admin.referrals') ? 'active' : '' }}">
              <a href="{{ route('admin.referrals') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/bonus.png') }}" alt="Referral Bonus" />User
                  Referral
              </a>
          </li>
          <li class="{{ request()->routeIs('admin.profile') ? 'active' : '' }} d-flex">
              <a href="{{ route('admin.profile') }}" class="sidebar-link">
                  <img src="{{asset('assets/themes/deepblack/img/icon/setting.png') }}" alt="Profile Settings" />
                  Profile Settings
              </a>
          </li>
      </ul>
          ...
          <nav class="navbar navbar-expand-lg fixed-top">
              <div class="container-fluid">
                  <a class="navbar-brand golden-text" href="{{ route('admin.dashboard') }}">
                      <h4 style="font-weight:bold; text-transform:Italics">Equitify Trades Lc
                      </h4>
                  </a>
                  <button type="button" id="sidebarCollapse" class="sidebar-toggler p-0">
                      <img src="{{asset('assets/themes/deepblack/img/icon/hamburger.png') }}" alt="hamburger image" />
                  </button>
                          ...
                          <ul class="notification-dropdown admin-dropdown">
                              <li>
                                  <a class="dropdown-item" href="{{ route('admin.dashboard') }}">
                                      <img src="{{asset('assets/themes/deepblack/img/icon/layout.png') }}"
                                          alt="Dashboard" />
                              ...
                              <li>
                                  <a class="dropdown-item" href="{{ route('admin.profile') }}">
                                      <img src="{{asset('assets/themes/deepblack/img/icon/profile.png') }}"
                                          alt="My Profile" />
                              ...
                              <!--
                                <li>
                                    <a class="dropdown-item" href="{{asset('admin/twostep-security">
                                        <img src="{{asset('assets/themes/deepblack//img/icon/padlock.png') }}" alt="2FA Security"/>
                              ...
                              <li>
                                  <a class="dropdown-item" href="{{ url('/') }}">
                                      <img src="{{asset('assets/themes/deepblack//img/icon/log-out.png') }}"
                                          alt="Logout" />
