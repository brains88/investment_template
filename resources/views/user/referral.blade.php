                    ...
                    <div class="col-xl-12">
                        <div class="box text-white">
                            ...
                            <div class="input-group">
                                <input type="text" value="{{ auth()->user()->referral_link }}" class="form-control"
                    ...
                    <div class="col-md-12">
                        <div class="d-flex justify-content-start " id="ref-label">
                            <div class="nav flex-column nav-pills mx-2" id="v-pills-tab" role="tablist"
                                ...
                                <a class=" nav-link    active   " id="v-pills-1-tab" href="javascript:void(0)"
                                    data-bs-toggle="pill" data-bs-target="#v-pills-1" role="tab"
                                    aria-controls="v-pills-1" aria-selected="true">Level 1</a>
                            </div>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-label="Phone Number">{{ $referral->referredUser->mobile }}
                                                    </td>
                                                    <td data-label="Joined At">
                                                        {{ $referral->referredUser->created_at->format('d M, Y h:i A') }}
                                                    </td>
                                                </tr>
                                                @empty
                                                <tr>
