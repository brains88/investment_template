                        ...
                        <div class="table-parent table-responsive">
                            <table class="table table-striped mb-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="5" class="text-center mt-3" class="alert alert-warning"
                                            role="alert">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span
                                                class="fontBold text-danger">-{{ number_format($transaction->amount, 2) }}
                                                USD</span>
                                            @else
                                            <span
                                                class="fontBold text-success">+{{ number_format($transaction->amount, 2) }}
                                                USD</span>
                                            @endif
                                        </td>
                                        <td>
