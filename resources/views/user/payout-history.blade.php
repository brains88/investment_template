...
<section class="transaction-history mt-5 pt-5">
    <div class="container-fluid">
        ...
        <form action="../user/payout-history-search" method="get">
                    ...
                    <table class="table table-striped mb-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($withdrawal->created_at)->format('d M Y h:i A') }}
                                </td>
                                <td>
                                    <button type="button" class="btn btn-success btn-sm infoButton"
                                        ...
                                        data-bank="{{ $withdrawal->bank_name }}" data-bs-toggle="modal"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="list-group">
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Transaction: <span class="trx"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Amount: <span class="amount"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">Bank
                        Name: <span class="bank"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Wallet Address: <span class="address"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Coin: <span class="coin"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Network: <span class="network"></span></li>
                    <li class="list-group-item list-group-item-primary bg-transparent lebelFont text-white">
                        Admin Feedback: <span class="feedback"></span></li>
                </ul>
...
infoButtons.forEach(button => {
    button.addEventListener('click', function() {
        ...
        const feedbackMessage = this.getAttribute('data-feedback');
