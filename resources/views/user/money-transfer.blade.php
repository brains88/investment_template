            ...
            <form id="transfer-form" class="form-row" action="{{ route('money-transfer.submit') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        ...
                        <input type="email" class="form-control" id="email" name="receiver_email" value=""
    ...
    $('#transfer-form').on('submit', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var alertMessage = $('<div class="alert alert-success">').text(data
                    .message);
            ...
            error: function(xhr, status, error) {
                ...
                var alertMessage = $('<div class="alert alert-danger">').text(response
