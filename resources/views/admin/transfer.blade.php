                            ...
                            <table class="table table-striped mb-5">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $transfer->sentTransfers->name }}</td>
                                        <td>{{ $transfer->receivedTransfers->name }}</td>
                                        <td>{{ $transfer->amount }} USD</td>
                                        <td class="text-success"> {{ $transfer->status }}</td>
                                        <td>{{ $transfer->created_at->format('d M Y h:i A') }}</td>
                                        <td>
                                            <button class="btn btn-danger delete-btn" data-id="{{ $transfer->id }}"
