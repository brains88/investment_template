        ...
        <div class="row justify-content-center">
          <div class="col-md-8">
            <div class="register-form-container p-4">
              <h5 class="text-center mb-4 mt-4 p-3 text-uppercase" :style="{ backgroundColor:'#fff', color: 'rgb(85, 43, 170)' }">Create Account</h5>
...
//For Referral
    async mounted() {
    // Fetch referral data from the session
    try {
  ...
  async handleRegister() {
    ...
    try {
      ...
      this.successMessage = 'Registration successful. Check your email for verification code.';
      this.fullname = '';
      this.email = '';
      this.mobile = '';
      this.username = '';
    ...
    mounted() {
        document.title = 'User Resigration | Equitify Trades';
    },
  };
  </script>
