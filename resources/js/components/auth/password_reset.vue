            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="register-form-container p-4">
                        <h5
                            class="text-center mb-4 mt-4 p-3 text-uppercase"
                            :style="{
                                backgroundColor: '#fff',
                                color: 'rgb(85, 43, 170)',
                            }"
                        ...
                        <form @submit.prevent="passwordReset">
                            <div class="row">
                                ...
                                <button
                                    type="submit"
                                    class="btn submit-btn w-100 mt-3 mb-3"
                                    :disabled="loading"
                                >
                                    <span
                                        v-if="loading"
...
export default {
    ...
    data() {
        return {
            ...
            errorMessage: "",
            successMessage: "",
            token: this.$route.params.token || "", // Ensure token is fetched
            email: this.$route.query.email || "", // Ensure email is fetched
        };
    },
