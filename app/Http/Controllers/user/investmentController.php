...
use App\Models\Plan;
use App\Models\User;
use App\Models\Withdrawal;use Illuminate\Http\Request;use Illuminate\Support\Facades\Auth;
...
class investmentController extends Controller
{
 ...
 {
  $investments = Investment::with('plan')->where('user_id', Auth::id())->orderBy('created_at', 'desc')->paginate(10);
  $userData    = auth()->user();
